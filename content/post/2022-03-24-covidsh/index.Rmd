...
重新拟后，感觉最好的机器学习的Glmnet模型，预测明天数字是25930，值得注意的是5号模型居然预测到13日将会是拐点（10日27474），拭目以待。
...
pre_data_tim <-  calibration_table %>%
  ...
  modeltime_forecast(h = "2 weeks", actual_data = ts_data) 
pre_data_tim %>%
  plot_modeltime_forecast(.interactive = FALSE)
