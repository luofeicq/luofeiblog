...
在这次疫情处理过程中，了解到在清理传播链的过程中，很多时候仍然是用手动在`powerpoint`等软件绘制传播链的。采用这种方式的优点能够在图中根据涉及者需要加入很多信息，比如：人员大致位置分布，接触的途径和强度等信息。不足之处在于，**在链条上节点（感染者）较少的时候还能够梳理得很明确，但一旦节点达到一定数量，且其中关系变得复杂**（比如1人传多个，1人与多个感染者有接触之类）。
